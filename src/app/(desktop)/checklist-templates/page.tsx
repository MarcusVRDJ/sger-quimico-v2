...
type TipoChecklist = "RECEBIMENTO" | "EXPEDICAO";
type StatusRevisao =
  | "RASCUNHO"
  | "PENDENTE_APROVACAO"
  | "APROVADO"
...
type TemplateSection = ChecklistTemplateDefinition["sections"][number];
type TemplateField = TemplateSection["fields"][number];

function defaultDefinition(tipo: TipoChecklist): ChecklistTemplateDefinition {
  if (tipo === "RECEBIMENTO") {
    return {
      schemaVersion: 1,
...
export default function ChecklistTemplatesPage() {
  ...
  function validateEditorDefinition(definicao: ChecklistTemplateDefinition): string | null {
